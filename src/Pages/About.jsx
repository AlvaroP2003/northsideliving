    ...
    return (
        <section className="flex flex-col gap-20 p-10 lg:p-20">
            ...
            <div className="flex flex-col items-center gap-5 p-10">
                <h2 className="text-neutral-600 font-semibold">REGISTERED WITH:</h2>
